  ...
  return <header className="fixed top-0 left-0 right-0 z-30 bg-background shadow-sm">
      <div className="flex justify-between items-center py-6 px-[30px]">
        ...
        <div className="hidden md:block">
          <span className="text-caption font-medium inline-flex items-baseline">尺度森林S.<span className="animate-grow-up" style={{ color: '#498422', fontSize: '2em', lineHeight: '1', transformOrigin: 'bottom center' }}>F</span>.A</span>
        </div>
