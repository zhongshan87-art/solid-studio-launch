  ...
  return <header className="fixed top-0 left-0 right-0 z-30 bg-background shadow-sm">
      <div className="flex justify-between items-center py-6 px-[30px]">
        ...
        <div className="hidden md:block">
          <span className="text-caption font-medium inline-flex items-end">尺度森林S.<span style={{ color: '#498422', fontSize: '2em', lineHeight: '0.5' }}>F</span>.A</span>
        </div>
        
        {/* Right side - Navigation */}
        <nav className="flex items-center gap-8 text-lg md:ml-auto">
          <Link to="/" className="text-caption font-medium hover:text-primary transition-colors inline-flex items-end">
            <span style={{ color: '#498422', fontSize: '2em', lineHeight: '0.5' }}>F</span>orest
          </Link>
